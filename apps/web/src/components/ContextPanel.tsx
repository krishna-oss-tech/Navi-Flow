            ...
            <div className="p-4 rounded-xl bg-gradient-to-b from-sky-950/30 to-surface border border-accent-blue/20 space-y-3 shadow-glow-blue">
              ...
              <div className="space-y-1">
                ...
                <div className="text-[10px] text-emerald-400 font-semibold mt-1">
                  ...
                  Risk Reduction: -{pendingRec.expectedRiskReduction} pts
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <button
                  onClick={() => onAcceptRecommendation(pendingRec.recommendationId)}
                  className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-bold shadow-sm transition-all duration-150 active:scale-95"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-surface hover:bg-surface-raised text-slate-200 text-[11px] font-semibold border border-border transition-all duration-150"
                >
            ...
            <div className="p-3 rounded-xl bg-surface border border-border-subtle text-[11px] text-slate-500 text-center">
              {junctionRisk?.policeAssigned ? (
                <div className="text-emerald-400 font-semibold flex items-center justify-center gap-1.5">
                  <UserCheck className="w-4 h-4" /> Police Unit Active
                </div>
              ) : (
      ...
      {overrideModalRec && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="w-full max-w-md glass-raised p-5 rounded-2xl border border-border space-y-4 animate-scale-in">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-white text-sm">Dispatch Override</h3>
              <button
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                placeholder="e.g. Officer closer via East corridor bypass..."
